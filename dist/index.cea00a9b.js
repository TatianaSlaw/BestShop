...
checkboxAccounting.addEventListener("change", function() {
    if (this.checked) costOfAccounting.children[1].innerText = "$20";
    else costOfAccounting.children[1].innerText = "$0";
});
checkboxTerminal.addEventListener("change", function() {
    if (this.checked) costOfTerminal.children[1].innerText = "$30";
    else costOfTerminal.children[1].innerText = "$0";
});
form.addEventListener("change", function() {
    ...
    costTotal.innerText = "$" + (productsQuantity.value * 0.5 + ordersQuantity.value * 2 + packageValue + AccountingValue + TerminalValue);
});
